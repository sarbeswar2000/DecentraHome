...
function App() {
  ...
  // register as a seller and buyer.
  const registerAsSeller = async () => {
    const signer = escrow.connect(
    ...
    <div>
      <BrowserRouter>
        <Routes>
          <Route
            ...
            element={
              <>
                ...
                {!isSeller && !isBuyer && (
                  <>
                    <button onClick={registerAsSeller}>
                      Register as Seller
                    </button>
                    <button onClick={registerAsBuyer}>Register as Buyer</button>
                  </>
                )}
                {isSeller && <p>You are registered as a Seller</p>}
                {isBuyer && <p>You are registered as a Buyer</p>} <Search />
          ...
          <Route
            path="/HomeForm"
            element={<HomeForm account={account}></HomeForm>}
          />
        </Routes>
      </BrowserRouter>
    </div>
